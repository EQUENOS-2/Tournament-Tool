    ...
    async def ball(self, ctx, *, query):
        qwords = {
            ...
            "зачем": [
                ...
                "Затем, что это хорошо сказывается на здоровье средне азиатских слонах."
            ],
            "где": [
            ...
            "когда": [
                ...
                "где",
                "Завтра.",
                "Через несколько недель - {randint(2, 10)}",
                "В {randint(2050, 3050)} году. Может быть даже в это же время."
            ],
            "кому": [
                "Ну, например, мне.",
            ...
            "кто": [
                f"Это ж как надо отстать от жизни, чтобы не знать этого? {choice(['Квит', 'Эквенос', 'Оптимист', 'Тролль', 'Инквизитор', 'Сеня', 'Генерал Панк', 'Вернон'])} конечно же!",
